...
The Next.js foundation, PostgreSQL/Drizzle schema, repeatable Acme Corp seed, project read/create/update, and member assignment/removal flows are in place. The next explicitly requested task will add project deletion.
