...
The Next.js foundation, PostgreSQL/Drizzle schema, repeatable Acme Corp seed, and project CRUD with member assignment/removal flows are in place. The next explicitly requested task will add an unauthenticated organization overview.
